...
cn_lego_drill_small = 4.7;
cn_lego_drill_large = 5.9;
...
module hole( in_height = cn_lego_height_beam, in_precision = 0.5, in_tollerance = 0.4 )
{
	an_cross_section = [
		//Bottom
		[0,0],
		...
		[0,in_height],
		//Top Big hole
		[cn_lego_drill_large/2+in_tollerance/2,in_height],
		[cn_lego_drill_large/2+in_tollerance/2,in_height-cn_lego_drill_depth_indent],
		//Top Small Hole
		[cn_lego_drill_small/2+in_tollerance/2,in_height-cn_lego_drill_depth_indent-cn_lego_drill_sharpness],
		//Bottom Small hole
		[cn_lego_drill_small/2+in_tollerance/2,cn_lego_drill_depth_indent+cn_lego_drill_sharpness],
		//Bottom Big Hole
		[cn_lego_drill_large/2+in_tollerance/2,cn_lego_drill_depth_indent],
		[cn_lego_drill_large/2+in_tollerance/2,0]
	];
